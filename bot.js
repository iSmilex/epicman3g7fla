...
first.on('ready', () => {
    ...
    console.log(`in ${first.guilds.size} servers `)
    console.log(`[Codes] ${first.users.size}`)
});

const prefix1 = "1"
first.on('message', async msg => { // eslint-disable-line
	...
	if (command === `play`) {
		...
		const permissions = voiceChannel.permissionsFor(msg.first.user);
    ...
    if(message.content.startsWith(prefix1 + "setname")) {
        ...
        message.channel.send(':white_check_mark: Done!').then(msg => {
          ...
          message.delete(5000);
		        ...
		        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
        first.user.setGame(args , 'https://twitch.tv/6xlez1');
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
        ...
        message.channel.send(':white_check_mark: Done!').then(msg => {
          ...
          message.delete(5000);
				        ...
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
        first.user.setActivity(args, {type:'LISTENING'});
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
				        ...
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
        first.user.setActivity(args, {type:'WATCHING'});
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
...
second.on('ready', () => {
    ...
    console.log(`in ${second.guilds.size} servers `)
    console.log(`[Codes] ${second.users.size}`)
});

const prefix2 = "2"
second.on('message', async msg => { // eslint-disable-line
	if (msg.author.bot) return undefined;
	...
	if (command === `play`) {
		const voiceChannel = msg.member.voiceChannel;
		if (!voiceChannel) return msg.channel.send('يجب توآجد حضرتك بروم صوتي .');
		const permissions = voiceChannel.permissionsFor(msg.second.user);
		if (!permissions.has('CONNECT')) {
...
${videos.map(video2 => `[**${++index} **] \`${video2.title}\``).join('\n')}`)
					...
					const videoIndex = parseInt(response.second().content);
					var video = await youtube.getVideoByID(videos[videoIndex - 1].id);
				} catch (err) {
					console.error(err);
					return msg.channel.send(':X: لا يتوفر نتآئج بحث ');
...
second.on('message', function(message) {
	const myID = "326131905743421440";
    let args = message.content.split(" ").slice(1).join(" ");
    if(message.content.startsWith(prefix2 + "setname")) {
		        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            second.user.setUsername(args);
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
		        ...
		        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            second.user.setGame(args , 'https://twitch.tv/6xlez1');
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
        ...
        message.channel.send(':white_check_mark: Done!').then(msg => {
          ...
          message.delete(5000);
				        ...
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            second.user.setActivity(args, {type:'LISTENING'});
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
				        ...
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            second.user.setActivity(args, {type:'WATCHING'});
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
...
third.on('ready', () => {
    ...
    console.log(`in ${third.guilds.size} servers `)
    console.log(`[Codes] ${third.users.size}`)
});

const prefix3 = "2"
third.on('message', async msg => { // eslint-disable-line
	if (msg.author.bot) return undefined;
	...
	if (command === `play`) {
		const voiceChannel = msg.member.voiceChannel;
		if (!voiceChannel) return msg.channel.send('يجب توآجد حضرتك بروم صوتي .');
		const permissions = voiceChannel.permissionsFor(msg.third.user);
		if (!permissions.has('CONNECT')) {
...
${videos.map(video2 => `[**${++index} **] \`${video2.title}\``).join('\n')}`)
					...
					const videoIndex = parseInt(response.third().content);
					var video = await youtube.getVideoByID(videos[videoIndex - 1].id);
				} catch (err) {
					console.error(err);
					return msg.channel.send(':X: لا يتوفر نتآئج بحث ');
...
third.on('message', function(message) {
	const myID = "326131905743421440";
    let args = message.content.split(" ").slice(1).join(" ");
    if(message.content.startsWith(prefix3 + "setname")) {
		        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            third.user.setUsername(args);
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
    } else if(message.content.startsWith(prefix3 + "stream")) {
		        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            third.user.setGame(args , 'https://twitch.tv/6xlez1');
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
    } else if(message.content.startsWith(prefix3 + "ply")) {
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            third.user.setGame(args);
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
    } else if(message.content.startsWith(prefix3 + "listen")) {
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            third.user.setActivity(args, {type:'LISTENING'});
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
    } else if(message.content.startsWith(prefix3 + "watch")) {
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
            third.user.setActivity(args, {type:'WATCHING'});
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
    } else if(message.content.startsWith(prefix3 + "setavatar")) {
				        if(message.author.id !== myID) return;
                        third.user.setAvatar(args);
        message.channel.send(':white_check_mark: Done!').then(msg => {
                if(!args) return message.reply('اكتب الحالة اللي تريدها.');
           msg.delete(5000);
          message.delete(5000);
...
third.on("message", message => {
 if (message.content === `${prefix3}`) {
  const embed = new Discord.RichEmbed() 
      .setColor('RANDOM')
      .setThumbnail(message.author.avatarURL)
      .setDescription(`
